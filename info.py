...
ADMIN_USRNM = environ.get('ADMIN_USRNM','helpsarthak_bot') # WITHOUT @
MAIN_CHANNEL_USRNM = environ.get('MAIN_CHANNEL_USRNM','Channel_UserName') # WITHOUT @
DEV_CHANNEL_USRNM = environ.get('DEV_CHANNEL_USRNM','know_sarthak16') # WITHOUT @
LAZY_YT_HANDLE = environ.get('LAZY_YT_HANDLE','shivthakare09')  # WITHOUT @ [  add only handle - don't add full url  ] 
...
CAPTION_BUTTON = "Buy Premium For DirectFiles"
